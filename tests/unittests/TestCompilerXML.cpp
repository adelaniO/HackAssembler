...
TEST(CompilerXML, TokenComments)
{
    Compiler::Tokenizer t1;
...
TEST(CompilerXML, CompileEmptyClass)
{
    Compiler::Tokenizer t1{};
...
TEST(CompilerXML, CompileVarDecs)
{
    Compiler::Tokenizer t1{};
...
TEST(CompilerXML, CompileClassVarDecs)
{
    Compiler::Tokenizer t1{};
...
TEST(CompilerXML, CompileLetStatements)
{
    Compiler::Tokenizer t1{};
    Compiler::CompilationEngine c1{&t1};
...
TEST(CompilerXML, CompileIfStatements)
{
    Compiler::Tokenizer t1{};
    Compiler::CompilationEngine c1{&t1};
...
TEST(CompilerXML, CompileWhileStatements)
{
    Compiler::Tokenizer t1{};
    Compiler::CompilationEngine c1{&t1};
     // Expressionless condition if
...
TEST(CompilerXML, CompileDoStatements)
{
    Compiler::Tokenizer t1{};
    Compiler::CompilationEngine c1{&t1};
     // Expressionless condition if
...
TEST(CompilerXML, CompileReturnStatements)
{
    Compiler::Tokenizer t1{};
    Compiler::CompilationEngine c1{&t1};
     // Expressionless condition if
...
TEST(CompilerXML, CompileSubroutineDec)
{
    Compiler::Tokenizer t1{};
    Compiler::CompilationEngine c1{&t1};
     // Empty
